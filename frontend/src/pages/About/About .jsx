...
const About = () => {
    ...
    return (
        <div className="container mx-auto flex min-h-screen justify-center items-center px-8">
            <div className="flex flex-col lg:flex-row items-center lg:items-start w-full max-w-7xl mx-auto">
